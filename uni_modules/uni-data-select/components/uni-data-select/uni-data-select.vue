<template>
	<view class="uni-stat__select">
		...
		<view :class="{'uni-stat__actived': current}" style="width: 100%;">
			<view class="uni-select">
				...
				<view class="uni-select__selector" v-if="showSelector">
					...
					<scroll-view scroll-y="true" class="uni-select__selector-scroll">
						...
						<view v-else class="uni-select__selector-item" :class="{'active': value == item.value}"
...
<script>
	 ...
	 */
	/**
	 * 手动更改说明     让select 可以100%占屏
	 * 取消outline
	 * 取消cursor
	 * 已经选择的项 添加active样式  style-lang使用scss
	 */
	export default {
